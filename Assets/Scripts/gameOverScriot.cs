...
public void restartBtnClicked()
{
 RestartGame(); // Call the RestartGame method when restart button is clicked
    ...
    public void UpdateScText()
    {
        ...
        // {
        //     // Get the score from the GameManager and update the final score text
        //     scoreFinalText.text = "Score: " + GameManager.instance.GetScore().ToString();
        // }
        // else
        // {
        //     scoreFinalText.text = "Score: 0"; // Fallback if GameManager is null
        // }
    
            scoreFinalText.text = "Score: " + GameManager.instance.GetScore().ToString();  // Access the score from GameManager
